  ...
  return (
    <>
      <section className="relative min-h-screen flex items-center justify-center pt-16 sm:pt-20 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="max-w-7xl px-4 md:px-0 mx-4 md:mx-auto text-center relative w-full">
          <div className="max-w-7xl mx-auto flex flex-col lg:grid lg:grid-cols-2 text-center lg:text-left gap-6 sm:gap-8 lg:gap-12 items-center relative">
            ...
            <div>
              ...
              <p className="text-md sm:text-base lg:text-lg text-gray-400 max-w-2xl mx-auto lg:mx-0 mb-6 sm:mb-8 animate-in slide-in-from-bottom duration-700 delay-200 leading-relaxed">
                ...
                completion, automated tasting, and smart debugging. Ship
                production-ready code 10x faster.
              </p>

              {/* -------buttons */}
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 sm:gap-4 mb-8 sm:mb-12 animate-in slide-in-from-bottom duration-700 delay-300">
                <button className="group w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-3 bg-gradient-to-b from-blue-600 to-blue-400 rounded-lg font-semibold sm:text-base transition-all duration-300 hover:scale-102 flex items-center justify-center gap-x-2">
                  Start Coding Free
                  <ArrowRight className="w-4 sm:w-5 h-4 sm:h-5 group-hover:translate-x-1 transition-transform duration-300" />
                </button>

                <button className="group w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-3 bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg font-semibold sm:text-base transition-all duration-300 hover:bg-white/10 flex items-center justify-center gap-x-2">
